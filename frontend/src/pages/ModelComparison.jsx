      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold text-white">Model Comparison &amp; Benchmarks</h1>
          ...
          <p className="text-surface-300 mt-1 text-sm">
            Evaluating XGBoost vs. Random Forest vs. Logistic Regression across 30 experimental runs.
          </p>
        </div>
        <button
          onClick={loadData}
